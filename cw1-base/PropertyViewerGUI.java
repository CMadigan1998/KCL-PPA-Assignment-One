...
public class PropertyViewerGUI
{
     ...
     * This code generates the window which displays the average price and total properties viewed for the session
     */
    private void showStatisticsButton () {
        JFrame statisticsFrame = new JFrame ("Session Statistics");
        JPanel content = new JPanel();
        content.add(new JLabel ("-{Current Session Statistics}-"));
        content.add(new JLabel (" || Average Price: " + viewer.averagePropertyPrice()));
        content.add(new JLabel (" || Total Properties Viewed: " + viewer.getNumberOfPropertiesViewed()));
        statisticsFrame.add(content, BorderLayout.CENTER);
    ...
    private void makeFrame()
    {
        ...
        statisticsButton.addActionListener(new ActionListener(){public void actionPerformed(ActionEvent E){showStatisticsButton();}});
